...
?>
  ...
  <div class="content bg-<?php echo $bodybackground; ?>">
    ...
    $select_stmt_13 = $conn->prepare("SELECT `Details`, `connect`, `show` FROM `text` WHERE id = 13");
    ...
    ?>
          ...
          <div class="clr"></div>
              <?php 
    // ดึงข้อมูล "id=3" จากตาราง 
    $select_stmt_24 = $conn->prepare("SELECT `Details`, `connect`, `show` FROM `text` WHERE id = 24");
    ...
    ?>
          ...
          <p></p><?php echo $Details_24; ?></p>
               <?php   } // ปิดเงื่อนไข if?>
                        <?php 
    // ดึงข้อมูล "id=3" จากตาราง 
    $select_stmt_25 = $conn->prepare("SELECT `Details`, `connect`, `show` FROM `text` WHERE id = 25");
