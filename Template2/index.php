...
<?php //style
$sql = "SELECT `background_colors` FROM `template_setting` WHERE id = 1";
...
?>
<?php //style
$sql = "SELECT `tab_header` FROM `template_setting` WHERE id = 1";
$stmt = $conn->prepare($sql);
$stmt->execute();
$result = $stmt->fetch(PDO::FETCH_ASSOC);
...
?>
<?php //style
$sql = "SELECT `register_button` FROM `template_setting` WHERE id = 1";
$stmt = $conn->prepare($sql);
$stmt->execute();
$result = $stmt->fetch(PDO::FETCH_ASSOC);
...
?>
<?php //style
$sql = "SELECT `login_button` FROM `template_setting` WHERE id = 1";
$stmt = $conn->prepare($sql);
$stmt->execute();
$result = $stmt->fetch(PDO::FETCH_ASSOC);
...
?>
<?php //style
$sql = "SELECT `tab_menu` FROM `template_setting` WHERE id = 1";
$stmt = $conn->prepare($sql);
$stmt->execute();
$result = $stmt->fetch(PDO::FETCH_ASSOC);
    ...
    <div class="container bg-<?php echo $body2background; ?>">
        ...
        <?php foreach ($images as $image): ?>
            ...
            <div class="col-md-6 px-0">
                <?php
                $sql = "SELECT `page1_text_sideshow` FROM `template_setting` WHERE id = 1";
                $stmt = $conn->prepare($sql);
                $stmt->execute();
                $result = $stmt->fetch(PDO::FETCH_ASSOC);
                ...
                ?>
                <?php
                $sql = "SELECT `page1_text_sideshow1` FROM `template_setting` WHERE id = 1";
                $stmt = $conn->prepare($sql);
                $stmt->execute();
                $result = $stmt->fetch(PDO::FETCH_ASSOC);
                ...
                ?>
                <?php
                $sql = "SELECT `page1_text_sideshow2` FROM `template_setting` WHERE id = 1";
                $stmt = $conn->prepare($sql);
                $stmt->execute();
                $result = $stmt->fetch(PDO::FETCH_ASSOC);
            ...
            <main>
                ...
                ?>
                    <!-- Trending Area Start -->
                    <?php
                    $sql = "SELECT `page1_content` FROM `template_setting` WHERE id = 1";
                    $stmt = $conn->prepare($sql);
                    $stmt->execute();
                    $result = $stmt->fetch(PDO::FETCH_ASSOC);
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="small-tittle mb-30">
                                                        <?php
                                                        $sql = "SELECT `page1_section1` FROM `template_setting` WHERE id = 1";
                                                        $stmt = $conn->prepare($sql);
                                                        $stmt->execute();
                                                        $result = $stmt->fetch(PDO::FETCH_ASSOC);
                ...
                ?>
                    <?php
                    $sql = "SELECT `page1_content2` FROM `template_setting` WHERE id = 1";
                    $stmt = $conn->prepare($sql);
                    $stmt->execute();
                    $result = $stmt->fetch(PDO::FETCH_ASSOC);
