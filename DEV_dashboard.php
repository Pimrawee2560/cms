...
<div class="wrapper">
    ...
    <div class="main_content">
        ...
        <div class="info">
            <a href="DEV_title.php"  class="btn btn-dark">TITLE</a>
            <a href="DEV_logo.php" class="btn btn-dark ">LOGO</a>
            <a href="DEV_menu.php" class="btn btn-dark">MENU</a>
            <a href="Dev_tabmenu.php"  class="btn btn-dark">TAB MENU</a>
            <a href="DEV_slideshow.php" class="btn btn-dark">SLIDESHOW</a>
            <a href="DEV_style.php"  class="btn btn-dark">STYLE</a>
            <a href="DEV_text.php"  class="btn btn-dark">TEXT</a>
            <a href="DEV_button.php"  class="btn btn-dark">BUTTON</a>
            <a href="DEV_icon.php"  class="btn btn-dark">ICON</a>
            ...
            ?>
            <a href="DEV_addnewpost.php"  class="btn btn-dark">ADD NEW POST</a>
            <div class="info">
