<?php 
    ...
    if (isset($_REQUEST['delete_id'])) {
        ...
        header("Location: DEV_post_video.php");
    }
...
<div class="wrapper">
    ...
    <div class="header">POST VIDEO</div>  
        <div class="info">
            ...
            ?>
            <a href="DEV_postaddnew_video.php"  class="btn btn-dark">ADD NEW POST VIDEO</a>
            <div class="info">
                ...
                <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="DEV_postedit_video.php?update_id=<?php echo $row["id"] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3" style="color: black;"></i></a>
