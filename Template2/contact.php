...
<style>
.jumbotron {
    background-size: cover; /* ปรับขนาดรูปภาพให้ครอบคลุมพื้นที่ทั้งหมดของ <div> */
    background-position: center; /* จัดตำแหน่งรูปภาพให้อยู่กลาง */
    min-height: 300px; /* ตั้งค่าสูงสุดของ <div> */
}
</style>
</head>
<?php //style
            ...
            <div class="header-mid bg-<?php echo $headerbackground; ?>" style="border: <?php echo $headerborder; ?>px solid <?php echo $headerbcolors; ?>; border-radius: <?php echo $headerradius; ?>px;">
                <div class="container">
                    <div class="row d-flex align-items-center">
                        ...
                        <?php 
                        $sql = "SELECT `register_button_homepage` FROM `template_setting` WHERE id = 1";
                        ...
                        <?php   } // ปิดเงื่อนไข if?>
                        <?php 
                             $sql = "SELECT `login_button_homepage` FROM `template_setting` WHERE id = 1";
                             $stmt = $conn->prepare($sql);
                             $stmt->execute();
                             $result = $stmt->fetch(PDO::FETCH_ASSOC);
...
<main>
    ...
    <section class="contact-section bg-<?php echo $contentbackground; ?>">
    <div class="container">
...
?>
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <?php   } // ปิดเงื่อนไข if?>
               <?php 
                                 $sql = "SELECT `page7_headcontact` FROM `template_setting` WHERE id = 1";
                                 $stmt = $conn->prepare($sql);
                                 $stmt->execute();
                                 $result = $stmt->fetch(PDO::FETCH_ASSOC);
            ...
            <div class="col-lg-3 offset-lg-1">
                <div class="media contact-info">
                    ...
                    <div class="media-body">
                        <h3><?php echo $Details_14; ?></h3>
                         <?php   } // ปิดเงื่อนไข if?>
                        <?php 
                                  $sql = "SELECT `page7_contact` FROM `template_setting` WHERE id = 1";
                                  $stmt = $conn->prepare($sql);
                                  $stmt->execute();
                                  $result = $stmt->fetch(PDO::FETCH_ASSOC);
                                  $page7_contact = $result['page7_contact'];  

                                $select_stmt_15 = $conn->prepare("SELECT `Details`, `connect`, `show` FROM `text` WHERE id = " . $page7_contact);
                                $select_stmt_15->execute();
                                $row_15 = $select_stmt_15->fetch(PDO::FETCH_ASSOC);
                                $Details_15 = $row_15['Details'];
                                $connect_15 = $row_15['connect'];
                                $show_15 = $row_15['show'];
                                // ตรวจสอบค่าในฟิลด์ "show"
                                if ($show_15 === 'on') { // เมื่อค่าในฟิลด์ "show" เป็น "on" เท่านั้น
            ?>
                        <p><?php echo $Details_15; ?></p>
                    </div>
                </div>
                 <?php   } // ปิดเงื่อนไข if?>
                <div class="media contact-info">
                    ...
                    <div class="media-body">
                                <?php 
                                $sql = "SELECT `page7_headcontact2` FROM `template_setting` WHERE id = 1";
                                $stmt = $conn->prepare($sql);
                                $stmt->execute();
                                $result = $stmt->fetch(PDO::FETCH_ASSOC);
                                $page7_headcontact2 = $result['page7_headcontact2'];  

                                $select_stmt_16 = $conn->prepare("SELECT `Details`, `connect`, `show` FROM `text` WHERE id = " . $page7_headcontact2);
                                $select_stmt_16->execute();
                                $row_16 = $select_stmt_16->fetch(PDO::FETCH_ASSOC);
                                $Details_16 = $row_16['Details'];
                                $connect_16 = $row_16['connect'];
                                $show_16 = $row_16['show'];
                                // ตรวจสอบค่าในฟิลด์ "show"
                                if ($show_16 === 'on') { // เมื่อค่าในฟิลด์ "show" เป็น "on" เท่านั้น
            ?>
                  
                        <h3><?php echo $Details_16; ?></h3>
                         <?php   } // ปิดเงื่อนไข if?>
                                <?php 
                                 $sql = "SELECT `page7_contact2` FROM `template_setting` WHERE id = 1";
                                 $stmt = $conn->prepare($sql);
                                 $stmt->execute();
                                 $result = $stmt->fetch(PDO::FETCH_ASSOC);
                                 $page7_contact2 = $result['page7_contact2'];  

                                $select_stmt_17 = $conn->prepare("SELECT `Details`, `connect`, `show` FROM `text` WHERE id = " . $page7_contact2);
                                $select_stmt_17->execute();
                                $row_17 = $select_stmt_17->fetch(PDO::FETCH_ASSOC);
                                $Details_17 = $row_17['Details'];
                                $connect_17 = $row_17['connect'];
                                $show_17 = $row_17['show'];
                                // ตรวจสอบค่าในฟิลด์ "show"
                                if ($show_17 === 'on') { // เมื่อค่าในฟิลด์ "show" เป็น "on" เท่านั้น
            ?>
                        <p><?php echo $Details_17; ?></p>
                        <?php   } // ปิดเงื่อนไข if?>
                    </div>
                </div>
                <div class="media contact-info">
                    ...
                    <div class="media-body">
                        <?php 
                                $sql = "SELECT `page7_headcontact3` FROM `template_setting` WHERE id = 1";
                                $stmt = $conn->prepare($sql);
                                $stmt->execute();
                                $result = $stmt->fetch(PDO::FETCH_ASSOC);
                                $page7_headcontact3 = $result['page7_headcontact3'];  

                                $select_stmt_18 = $conn->prepare("SELECT `Details`, `connect`, `show` FROM `text` WHERE id = " . $page7_headcontact3);
                                $select_stmt_18->execute();
                                $row_18 = $select_stmt_18->fetch(PDO::FETCH_ASSOC);
                                $Details_18 = $row_18['Details'];
                                $connect_18 = $row_18['connect'];
                                $show_18 = $row_18['show'];
                                // ตรวจสอบค่าในฟิลด์ "show"
                                if ($show_18 === 'on') { // เมื่อค่าในฟิลด์ "show" เป็น "on" เท่านั้น
            ?>
                        <h3><?php echo $Details_18; ?></h3>
                         <?php   } // ปิดเงื่อนไข if?>
                        <?php 
                                 $sql = "SELECT `page7_contact3` FROM `template_setting` WHERE id = 1";
                                 $stmt = $conn->prepare($sql);
                                 $stmt->execute();
                                 $result = $stmt->fetch(PDO::FETCH_ASSOC);
                                 $page7_contact3 = $result['page7_contact3'];  

                                $select_stmt_19 = $conn->prepare("SELECT `Details`, `connect`, `show` FROM `text` WHERE id =  " . $page7_contact3);
                                $select_stmt_19->execute();
                                $row_19 = $select_stmt_19->fetch(PDO::FETCH_ASSOC);
                                $Details_19 = $row_19['Details'];
                                $connect_19 = $row_19['connect'];
                                $show_19 = $row_19['show'];
                                // ตรวจสอบค่าในฟิลด์ "show"
                                if ($show_19 === 'on') { // เมื่อค่าในฟิลด์ "show" เป็น "on" เท่านั้น
            ?>
                        <p><?php echo $Details_19; ?></p>
                         <?php   } // ปิดเงื่อนไข if?>
                    </div>
                </div>
            </div>
...
<?php 
    $sql = "SELECT `footer_background` FROM `template_setting` WHERE id = 1";
    $stmt = $conn->prepare($sql);
    $stmt->execute();
    $result = $stmt->fetch(PDO::FETCH_ASSOC);
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-8">
                        <div class="single-footer-caption text-center">
                            ...
                            <div class="footer-tittle">
                                ...
                                <?php 
                                $sql = "SELECT `footer` FROM `template_setting` WHERE id = 1";
                                $stmt = $conn->prepare($sql);
                                $stmt->execute();
                                $result = $stmt->fetch(PDO::FETCH_ASSOC);
                                ...
                                <?php   } // ปิดเงื่อนไข if?>
                                <?php 
                                $sql = "SELECT `footer2` FROM `template_setting` WHERE id = 1";
                                $stmt = $conn->prepare($sql);
                                $stmt->execute();
                                $result = $stmt->fetch(PDO::FETCH_ASSOC);
                                ...
                                <?php   } // ปิดเงื่อนไข if?>
                                <?php 
                                $sql = "SELECT `footer3` FROM `template_setting` WHERE id = 1";
                                $stmt = $conn->prepare($sql);
                                $stmt->execute();
                                $result = $stmt->fetch(PDO::FETCH_ASSOC);
