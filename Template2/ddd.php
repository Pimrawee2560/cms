...
<head>
    ...
    $select_stmt_title = $conn->prepare("SELECT `name` FROM `title` WHERE id = 8");
    ...
    <?php
    $select_stmt_title = $conn->prepare("SELECT `image`, `show` FROM `title` WHERE id = 8");
    $select_stmt_title->execute();
    $row_title = $select_stmt_title->fetch(PDO::FETCH_ASSOC);
    ...
    <div class="container bg-<?php echo $body2background; ?>">
                    ...
                    <div class="container">
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-4 d-flex justify-content-end align-items-center ml-auto">
                                ...
                                $select_stmt_one = $conn->prepare("SELECT `name`, `connect`, `show` FROM `button` WHERE id = 1");
                                ...
                                <?php
                                // ดึงข้อมูล "id=3" จากตาราง button
                                $select_stmt_two = $conn->prepare("SELECT `name`, `connect`, `show` FROM `button` WHERE id = 2");
        ...
        <?php foreach ($images as $image): ?>
            ...
            <div class="col-md-6 px-0">
                <?php
                // ดึงข้อมูล "id=3" จากตาราง button
                $select_stmt_one = $conn->prepare("SELECT `Details`, `connect`, `show` FROM `text` WHERE id = 1");
                $select_stmt_one->execute();
                $row_one = $select_stmt_one->fetch(PDO::FETCH_ASSOC);
                ...
                <?php
                // ดึงข้อมูล "id=3" จากตาราง button
                $select_stmt_two = $conn->prepare("SELECT `Details`, `connect`, `show` FROM `text` WHERE id = 2");
                $select_stmt_two->execute();
                $row_two = $select_stmt_two->fetch(PDO::FETCH_ASSOC);
                ...
                <?php
                // ดึงข้อมูล "id=3" จากตาราง button
                $select_stmt_three = $conn->prepare("SELECT `Details`, `connect`, `show` FROM `text` WHERE id = 3");
                        ...
                        <div class="container">
                            <div class="trending-main">
                                <div class="row">
                                            ...
                                            try {
                                                ...
                                                if ($stmt->rowCount() > 0) {
                                                    ...
                                                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                        ...
                                                        echo '<img src="upload/' . $row["image"] . '" alt="' . $row["Title"] . '" style="width: 750px; height: 654px;">';
                                                        ...
                                                        echo '</div></div></div></div>'; // ปิด div.single-slider
                                                    }
                                                } else {
                                                    echo "0 รายการของข่าว";
                                                }
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="row">
                                            <?php
                                            try {
                                                $sql = "SELECT * FROM addnewpost WHERE Status = 'Publish' ORDER BY RAND() LIMIT 9";
                                                $stmt = $conn->prepare($sql);
                                                $stmt->execute();
                                                ...
                                                if ($stmt->rowCount() > 0) {
                                                    ...
                                                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                        ...
                                                        echo '<div class="trending-top mb-30">';
                                                        echo '<div class="trend-top-img">';
                                                        echo '<img src="upload/' . $row["image"] . '" alt="' . $row["Title"] . '" style="width: 100%; height: auto;">';
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="small-tittle mb-30">
                                                                        ...
                                                                        $select_stmt_four = $conn->prepare("SELECT `Details`, `connect`, `show` FROM `text` WHERE id = 4");
                                                                        ...
                                                                        try {
                                                                            ...
                                                                            if ($stmt->rowCount() > 0) {
                                                                                ...
                                                                                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                                                    ...
                                                                                    echo '<img src="upload/' . $row["image"] . '" alt="' . $row["Title"] . '" style="width: 235px; height: 155px;">';
                                                                                    echo '</div>';
                                ...
                                ?>
                                    <?php
                                    // ดึงข้อมูล "id=1" จากตาราง menu
                                    $select_stmt_content2 = $conn->prepare("SELECT colors, `tcolors`, `border`, `radius`, `bcolors` FROM `colors` WHERE id = 7");
                                                            ...
                                                            try {
                                                                ...
                                                                if ($stmt->rowCount() > 0) {
                                                                    ...
                                                                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                                        ...
                                                                        echo '<img src="upload/' . $row["image"] . '" alt="' . $row["Title"] . '" style="width: 263px; height: 210px;">';
                                                                        echo '</div>';
                                                                        ...
                                                                        try {
                                                                            ...
                                                                            if ($stmt->rowCount() > 0) {
                                                                                ...
                                                                                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                                                    ...
                                                                                    echo '<img src="upload/' . $row["image"] . '" alt="' . $row["Title"] . '" width="1130" height="680">';
                                                                                    echo '<div style="position: absolute; bottom: 0; left: 0; background-color: red; color: white; padding: 5px 10px;" class="bg-danger">Video</div>';
                                                                                    echo '</div>';
                                                                                    echo '</a>';
                                                                                    echo '<div class="video-intro">';
                                                                                    echo '<h4>' . $row["Title"] . ' | ' . $row["day"] . '</h4>';
                                                                                    echo '</div>';
