<?php 
    ...
    if (isset($_REQUEST['btn_update'])) {
        try {
            ...
            if (!isset($errorMsg)) {
                $update_stmt = $conn->prepare("UPDATE `postvideo` SET Title = :Title, Status = :Status, content = :content, day = :day, image = :image, video = :video WHERE id = :id");
                ...
                $update_stmt->bindParam(':video', $video_file);
                $update_stmt->bindParam(':id', $id);

                if ($update_stmt->execute()) {
                    $updateMsg = "File update successfully...";
                    header("refresh:2;Admin_post_video.php");
                }
            }
    ...
    <div class="container d-flex justify-content-center">
        ...
        <form action="" method="post" style="width:50vw; min-width:300px;" class="form-horizontal" enctype="multipart/form-data">
            <div class="row mb-3">
                ...
                <div class="form-group mb-3">
                    <label for="name">Uploaded video:</label>
                    <p>
                        <?php if(isset($video)) { ?>
                ...
                <div>
                    ...
                    <a href="Admin_post_video.php" class="btn btn-danger">Cancel</a>
                </div>
            </div>
        </form>
    </div>
