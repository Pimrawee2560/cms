...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="Template2//font-awesome-4.7.0/css/font-awesome.min.css">
...
?>
	...
	<div class="container bg-<?php echo $contentbackground; ?>">
		<div class="headline bg0 flex-wr-sb-c p-rl-20 p-tb-8 bg-<?php echo $contentbackground; ?>">
			<div class="f2-s-1 p-r-30 m-tb-6 ">
				...
				<a href="Page4.php" class="breadcrumb-item f1-s-3 cl9 text-<?php echo $content2background; ?>">
					Blog 
				</a>
	...
	<!-- Content -->
	<section class="bg0 p-b-70 p-t-5 bg-<?php echo $contentbackground; ?>">
		<!-- Title -->
		<div class="bg-img1 size-a-18 how-overlay1" style="background-image: url(upload/<?php echo $Postimage; ?>);">
			<div class="container h-full flex-col-e-c p-b-58 ">
				...
				<div class="flex-wr-c-s">
					<span class="f1-s-3 cl8 m-rl-7 txt-center" >
						<a href="#" class="f1-s-4 cl8 hov-cl10 trans-03 style="color: white;">
						<?php echo $Postday; ?>
