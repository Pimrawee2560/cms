                        ...
                        ?>
                            <div class="col-lg-3 offset-lg-1">
                                <div class="media contact-info">
                                    ...
                                    <?php
                                    $template_setting_id = 1;
                                    $sql = "SELECT `page7_contact` FROM `template_setting`  WHERE id = " . $template_setting_id;
                                    $stmt = $conn->prepare($sql);
                                    $stmt->execute();
                                    $result = $stmt->fetch(PDO::FETCH_ASSOC);
                            ...
                            <div class="media contact-info">
                                ...
                                <div class="media-body">
                                    <?php
                                    $template_setting_id = 1;
                                    $sql = "SELECT `page7_headcontact2` FROM `template_setting`  WHERE id = " . $template_setting_id;
                                    $stmt = $conn->prepare($sql);
                                    $stmt->execute();
                                    $result = $stmt->fetch(PDO::FETCH_ASSOC);
                                    ...
                                    <?php
                                    $template_setting_id = 1;
                                    $sql = "SELECT `page7_contact2` FROM `template_setting`  WHERE id = " . $template_setting_id;
                                    $stmt = $conn->prepare($sql);
                                    $stmt->execute();
                                    $result = $stmt->fetch(PDO::FETCH_ASSOC);
                            ...
                            <div class="media contact-info">
                                ...
                                <div class="media-body">
                                    <?php
                                    $template_setting_id = 1;
                                    $sql = "SELECT `page7_headcontact3` FROM `template_setting`  WHERE id = " . $template_setting_id;
                                    $stmt = $conn->prepare($sql);
                                    $stmt->execute();
                                    $result = $stmt->fetch(PDO::FETCH_ASSOC);
                                    ...
                                    <?php
                                    $template_setting_id = 1;
                                    $sql = "SELECT `page7_contact3` FROM `template_setting`  WHERE id = " . $template_setting_id;;
                                    $stmt = $conn->prepare($sql);
                                    $stmt->execute();
                                    $result = $stmt->fetch(PDO::FETCH_ASSOC);
