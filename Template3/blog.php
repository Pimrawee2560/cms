    ...
    <div class="content_resize bg-<?php echo $conntentbackground; ?>">
      <div class="mainbar">
        <div class="article">
          ...
          <img src="upload/<?php echo $Postimage; ?>" alt="IMG" style="display: block; margin-bottom: 20px;">
          ...
          <p>Posted Date: <?php echo $Postday; ?></p>
        </div>
        <div class="article">
<?php 
// ดึงข้อมูล "id=3" จากตาราง button
$select_stmt_showone = $conn->prepare("SELECT `show` FROM `related` WHERE id = 15");
