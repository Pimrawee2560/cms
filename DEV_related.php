<?php 
    ...
    if (isset($_REQUEST['delete_id'])) {
        ...
        $delete_stmt = $conn->prepare('DELETE FROM `related` WHERE id = :id');
        $delete_stmt->bindParam(':id', $id);
        $delete_stmt->execute();

        header('Location:DEV_related.php');
    }
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="wrapper">
    ...
    <div class="header">POST SHOW</div>  
        <div class="info">
                <div class="display-3 text-center">POST SHOW</div>
                <div class="container">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
            <?php 
                $select_stmt = $conn->prepare("SELECT * FROM `related`");
                $select_stmt->execute();
            ...
            ?>
                            ...
                            <tr>
                                ...
                                <td><a href="DEV_relatededit.php?update_id=<?php echo $row["id"]; ?>"
